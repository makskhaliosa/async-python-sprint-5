...
Создайте файл .env в корне проекта с переменными окружения по примеру .env-sample.
В переменную APP_CRYPTO_SECRET_KEY поместите ключ, сгенерированный командой:
